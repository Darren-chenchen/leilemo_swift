...
class MilitaryViewController: UIViewController {
...
//MARK: - 数据解析
extension MilitaryViewController{
    
    fileprivate func setupNet(footRefresh:Bool){
        let urlStr = "http://vcsp.ifeng.com/vcsp/appData/recommendGroupByTeamid.do?isNotModified=0&useType=iPhone&adapterNo=6.11.1&showType=double&"+self.positionStr+"&channelId=100377-0"
...
extension MilitaryViewController:UITableViewDelegate,UITableViewDataSource{
